...
//    @GetMapping("/{cid}/subtopics")
     ...
     *  <ul>
     *      <li>{@link HttpStatus#OK}: Curriculum successfully marked as master version.</li>    
     *      <li>{@link HttpStatus#BAD_REQUEST}: Could not find a curriculum with the provided ID.</li>
     *  </ul>
     * 
     * 
    ...
    public ResponseEntity<Curriculum> markCurriculumAsMaster(@PathVariable Integer cid) {
     ...
     *      <li>{@link HttpStatus#INTERNAL_SERVER_ERROR}: Failed to add the curriculum.</li>
     *  </ul>
     * 
     * @author Ricky Baker (1802-Matt)
     * 
     * @param newCurriculum The curriculum to add.
     * @return The added curriculum if the add was successful; otherwise, {@literal null}.
     */
    @PostMapping("/")
    public ResponseEntity<Curriculum> addCurriculum(@RequestBody Curriculum newCurriculum) {
        ResponseEntity<Curriculum> response;
        HttpStatus status = HttpStatus.OK;
     ...
     * @author Ricky Baker (1802-Matt)
     * 
     * @param curriculumId The ID of the curriculum the selected subtopics 
     *                     belong to.
     * @param subtopicIds The IDs of the subtopics to delete.
     * @return Always {@literal null}.
     */
    @DeleteMapping("/{cid}/subtopics")
    public ResponseEntity<Void> deleteSubtopics(@PathVariable("cid") Integer curriculumId, 
     ...
     * @author Ricky Baker (1802-Matt) 
     *  
     * @param curriculumIds IDs of the curriculums to delete. 
     * @return Always {@literal null}.
     */
    @DeleteMapping("/")
     ...
     * @author Ricky Baker (1802-Matt)
     * 
     * @param curriculum The curriculum data to update with. Fields set to null
     *          are ignored.
    ...
    /**
     * Updates an existing curriculum with all fields of the given 
     * curriculum data.
     *  <ul>
     ...
     * @author Ricky Baker (1802-Matt)
     * 
     * @param curriculum The curriculum data to update with. All fields are 
     *          replaced with the provided data.
     * @return The updated curriculum.
     */
    @PutMapping("/")
    public ResponseEntity<Curriculum> replaceCurriculum(@RequestBody Curriculum curriculum) {
        Curriculum updatedCurriculum;
        HttpStatus status = HttpStatus.OK;
        ResponseEntity<Curriculum> response;
        try {
     ...
     *  <ul>
     *      <li>{@link HttpStatus#OK}: Successfully linked subtopics to curriculum.</li>
     ...
     * @author Ricky Baker (1802-Matt)
     * 
     * @param cid The curriculum to link the subtopics to.
     * @param subtopicIds The IDs of the subtopics to link to a curriculum.
     * @return Always {@literal null}.
     */
    @HystrixCommand(fallbackMethod="insertSubtopicsToCurriculumFallback")
    @PutMapping("/{cid}")
    public ResponseEntity<Void> insertSubtopicsToCurriculum(@PathVariable Integer cid,
    ...
    /**
     * Hystrix fallback method for {@link #insertSubtopicsToCurriculum(Integer, Set)}.
     * 
